...
Version  : 2.5.2
Release  : 24
URL      : https://github.com/uclouvain/openjpeg/archive/v2.5.2/openjpeg-2.5.2.tar.gz
Source0  : https://github.com/uclouvain/openjpeg/archive/v2.5.2/openjpeg-2.5.2.tar.gz
...
%prep
%setup -q -n openjpeg-2.5.2
cd %{_builddir}/openjpeg-2.5.2
pushd ..
cp -a openjpeg-2.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722361084
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libopenjp2.so.2.5.2
/usr/lib64/libopenjp2.so.2.5.2
